...
using RobRef.DDD.Users.Application;
using RobRef.DDD.Users.Application.Users.Services;
using RobRef.DDD.Users.Infrastructure;
using RobRef.DDD.Users.WebApi.Infrastructure;
...
{
    builder.Services.AddUsersInfrastructureInMemory();
}
else
{
    ...
    builder.Services.AddUsersInfrastructureSqlServer(connectionString);
}
